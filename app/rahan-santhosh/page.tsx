...
const personSchema = {
  ...
  url: "https://fundaux.finance/rahan-santhosh",
  image: "https://fundaux.finance/founder.jpg",
  ...
  worksFor: {
    ...
    description: "Structured financial management firm helping individuals and organisations pursue their financial goals.",
    foundingDate: "2021",
    founder: {
      "@type": "Person",
      name: "Rahan Santhosh",
